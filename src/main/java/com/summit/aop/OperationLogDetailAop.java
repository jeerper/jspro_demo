...
import com.summit.dao.entity.OperateLogModel;
...
/**
 * @author: jeerper
 * @since: 2020/12/31 15:32
 */
@Aspect
@Component
public class OperationLogDetailAop {
    /**
     * 此处的切点是注解的方式，也可以用包名的方式达到相同的效果
     * '@Pointcut("execution(* com.wwj.springboot.service.impl.*.*(..))")'
     */
    @Pointcut("@annotation(com.summit.annotation.OperationLogDetail)")
    ...
    private void addOperationLog(JoinPoint joinPoint, Object res, long time){
        ...
        OperateLogModel operationLog = new OperateLogModel();
