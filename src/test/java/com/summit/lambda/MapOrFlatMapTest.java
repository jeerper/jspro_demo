...
public class MapOrFlatMapTest {
    ...
    public void testMap(){
        ...
        logger.info("words 长度是words:{}", ""+collect); //words 长度是:[5, 7, 2]
    ...
    public void testMap2(){
        ...
        List<String[]> collect2 = words.stream()
                ...
                .distinct()
                .collect(toList());
        logger.info("collect2 集合是:{}", JSONObject.toJSONString(collect2));//collect2 集合是:[["h","e","l","l","o","w","o","r","l","d"]]
    }
    @Test
    public void testFlatMap(){
        ...
        logger.info("collect 集合是:{}", JSONObject.toJSONString(collect));// collect 集合是:["h","e","l","o","w","r","d"]
    }
}
